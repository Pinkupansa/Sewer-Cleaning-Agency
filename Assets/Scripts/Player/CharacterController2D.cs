...
public class CharacterController2D : MonoBehaviour
{
    ...
    public void Move(float hMove, float vMove, bool crouch, bool jump, bool climb)
    {
        ...
        if (m_Grounded || m_AirControl)
        {
            ...
            Vector3 targetVelocity = new Vector2(hMove * 10f, !climb?m_Rigidbody2D.velocity.y:vMove*10f);
    ...
    private void Flip()
    {
        ...
        LeanTween.rotate(gameObject, new Vector3(0, (m_FacingRight==false?1:0) * 180, 0), 0.2f);
    }
}